...
public class StringsAndCoinsBoard extends JPanel
{
	private int columns;
	private int rows;
	private int width;
	...
	public StringsAndCoinsBoard(int columns, int rows, int width, int height, int buffer, Graph graph)
	{
	...
	private void drawDot(Graphics2D g, int x, int y)
	{
		...
		g.fill(new Ellipse2D.Double(posX-(coinSize/2), posY-(coinSize/2), coinSize, coinSize));
	}
